...
new #[Title('Log issue')] class extends Component {
    ...
    public string $tags = '';
    public array $attempts = [['description' => '', 'result' => 'failed']];
            ...
            <div class="space-y-4">
                ...
                @foreach ($attempts as $index => $attempt)
                    <div class="grid gap-3 md:grid-cols-[1fr_9rem_auto]">
                        <flux:input wire:model="attempts.{{ $index }}.description" :label="__('Attempt :number', ['number' => $index + 1])" />
